...
for reali=1:realization
    ...
    for snr=1:length(PP)
        ...
        sumrate_MMSE(reali,snr)=sumrate_mmse;
        ...
        sumrate_WMMSE(reali,snr)=sumrate1;

        %% F-WMMSE
        Grx=6; Grz=Grx; Gr=Grx*Grz;
        G_R=zeros(L,Gr,K);
        Gtx=12; Gtz=Gtx; Gt=Gtx*Gtz;
        G_T=zeros(L*K,Gt);
        ...
        sumrate_FWMMSE(reali,snr)=sumrate;
